...
realValidDir = "/lustre/gk36/k77012/M2/data/{}/".format(realValidPath)
...
df_realValid = pd.read_csv("/lustre/gk36/k77012/M2/{}".format(realValidBbox))
...
for epoch in range(num_epoch):
    ...
    print("epoch:{}/{}  tr_loss:{:.3f}  val_loss:{:.3f}  val_IoU:{:.3f}  val_Dice:{:.3f}  realVal_loss:{:.3f}  realVal_IoU:{:.3f}  realVal_Dice:{:.3f}  test_IoU:{:.3f}  test_Dice:{:.3f}".format(
