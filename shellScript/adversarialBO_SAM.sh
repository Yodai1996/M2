...
numInfer=30 #30 #how many images are generated by the simulator for inference
optimizer='SAM'

bufText="/lustre/gk36/k77012/M2/buf_adversarialBO_${optimizer}.txt" #use the same text as it is just a buffer
bestText="/lustre/gk36/k77012/M2/best_adversarialBO_${optimizer}.txt"
...
do
  ...
  boText="/lustre/gk36/k77012/M2/bo_io/in/adversarialBO/${optimizer}/iter${i}.txt"
  ...
  do
    ...
    #save information
    abnormalDir="/lustre/gk36/k77012/M2/data/adversarialBO/${optimizer}/ver${i}/iter${j}_${numInfer}/"
    segMaskDir="/lustre/gk36/k77012/M2/SegmentationMask/adversarialBO/${optimizer}/ver${i}/mask${j}_${numInfer}/" #まあ無くてもよさそう
    paraDir="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/adversarialBO/${optimizer}/ver${i}/"
    bboxDir="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/adversarialBO/${optimizer}/ver${i}/"
  ...
  abnormalDir="/lustre/gk36/k77012/M2/data/adversarialBO/${optimizer}/${trainPath}/"
  segMaskDir="/lustre/gk36/k77012/M2/SegmentationMask/adversarialBO/${optimizer}/ver${i}_${numTrain}/"
  paraPath="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/adversarialBO/${optimizer}/parameterInfo${i}_${numTrain}.csv"
  bboxPath="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/adversarialBO/${optimizer}/bboxInfo${i}_${numTrain}.csv"
  ...
  abnormalDir2="/lustre/gk36/k77012/M2/data/adversarialBO/${optimizer}/${validPath}/"
  segMaskDir2="/lustre/gk36/k77012/M2/SegmentationMask/adversarialBO/${optimizer}/ver${i}_${numValid}/"
  paraPath2="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/adversarialBO/${optimizer}/parameterInfo${i}_${numValid}.csv"
  bboxPath2="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/adversarialBO/${optimizer}/bboxInfo${i}_${numValid}.csv"
  ...
  savePath="adversarialBO/${optimizer}/${trainPath}/${validPath}_test${testPath}/${model}_batch${batch_size}_epoch${epoch}"
  ...
  modelPath="/lustre/gk36/k77012/M2/model/adversarialBO/${optimizer}/"
  mkdir -p ${modelPath}
  mkdir -p "/lustre/gk36/k77012/M2/train_log/adversarialBO/${optimizer}/"

  #training the model
  python ../codes/train_continual.py ${abnormalDir} ${abnormalDir2} ${testPath} ${bboxPath} ${bboxPath2} ${testBbox} ${modelPath} ${model} ${epoch} ${batch_size} ${numSamples} ${i} ${savePath} ${optimizer} >> ../train_log/adversarialBO/${optimizer}/model${i}_${trainPath}_${validPath}_${testPath}_${model}_epoch${epoch}_batchsize${batch_size}.txt
  echo $i'_finished'
