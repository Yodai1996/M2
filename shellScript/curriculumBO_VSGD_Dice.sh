...
do
  ...
  #training the model
  python ../codes/train_continual.py ${abnormalDir} ${abnormalDir2} ${realValidPath} ${testPath} ${bboxPath} ${bboxPath2} ${realValidBbox} ${testBbox} ${modelPath} ${model} ${epoch} ${batch_size} ${numSamples} ${i} ${savePath} ${optimizer} ${metric} ${variability} ${decayRate} >> ../train_log/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}_variability${variability}_decay${decayRate}/model${i}_${trainPath}_${validPath}_${testPath}_${model}_epoch${epoch}_batchsize${batch_size}.txt
  echo $i'_finished'
