...
numIter=30 #4 #iteration for BO
numInfer=30 #how many images are generated by the simulator for inference

bufText="/lustre/gk36/k77012/M2/buf_adversarialBO.txt" #use the same text as it is just a buffer
bestText="/lustre/gk36/k77012/M2/best_adversarialBO.txt"
...
do
  ...
  do
    ...
    #save information
    abnormalDir="/lustre/gk36/k77012/M2/data/adversarialBO/ver${i}/iter${j}_${numInfer}/"
    segMaskDir="/lustre/gk36/k77012/M2/SegmentationMask/adversarialBO/ver${i}/mask${j}_${numInfer}/" #まあ無くてもよさそう
    paraDir="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/adversarialBO/ver${i}/"
    bboxDir="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/adversarialBO/ver${i}/"
  ...
  abnormalDir="/lustre/gk36/k77012/M2/data/adversarialBO/${trainPath}/"
  segMaskDir="/lustre/gk36/k77012/M2/SegmentationMask/adversarialBO/ver${i}_${numTrain}/"
  paraPath="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/adversarialBO/parameterInfo${i}_${numTrain}.csv"
  bboxPath="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/adversarialBO/bboxInfo${i}_${numTrain}.csv"
  ...
  abnormalDir2="/lustre/gk36/k77012/M2/data/adversarialBO/${validPath}/"
  segMaskDir2="/lustre/gk36/k77012/M2/SegmentationMask/adversarialBO/ver${i}_${numValid}/"
  paraPath2="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/adversarialBO/parameterInfo${i}_${numValid}.csv"
  bboxPath2="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/adversarialBO/bboxInfo${i}_${numValid}.csv"
  ...
  savePath="adversarialBO/${trainPath}/${validPath}_test${testPath}/${model}_batch${batch_size}_epoch${epoch}"
  ...
  #training the model
  python ../codes/train_continual.py ${trainPath} ${validPath} ${testPath} ${bboxPath} ${bboxPath2} ${testBbox} ${model} ${epoch} ${batch_size} ${numSamples} ${i} ${savePath} "adversarialBO" >> ../train_log/adversarialBO/model${i}_${trainPath}_${validPath}_${testPath}_${model}_epoch${epoch}_batchsize${batch_size}.txt
