...
#PBS -o curriculumBO_SAM_Dice.txt
#PBS -j oe
#PBS -m abe
...
bestText="/lustre/gk36/k77012/M2/best_curriculumBO${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}.txt"
...
modelPath="/lustre/gk36/k77012/M2/model/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/"
mkdir -p ${modelPath}
mkdir -p "/lustre/gk36/k77012/M2/train_log/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}"
...
do
  ...
  boDir="/lustre/gk36/k77012/M2/bo_io/in/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}"
  mkdir -p ${boDir}
  ...
  do
    ...
    #save information
    abnormalDir="/lustre/gk36/k77012/M2/data/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/ver${i}/iter${j}_${numInfer}/"
    segMaskDir="/lustre/gk36/k77012/M2/SegmentationMask/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/ver${i}/mask${j}_${numInfer}/" #まあ無くてもよさそう
    paraDir="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/ver${i}/"
    bboxDir="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/ver${i}/"
  ...
  abnormalDir="/lustre/gk36/k77012/M2/data/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/${trainPath}/"
  segMaskDir="/lustre/gk36/k77012/M2/SegmentationMask/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/ver${i}_${numTrain}/"
  paraPath="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/parameterInfo${i}_${numTrain}.csv"
  bboxPath="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/bboxInfo${i}_${numTrain}.csv"
  ...
  abnormalDir2="/lustre/gk36/k77012/M2/data/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/${validPath}/"
  segMaskDir2="/lustre/gk36/k77012/M2/SegmentationMask/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/ver${i}_${numValid}/"
  paraPath2="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/parameterInfo${i}_${numValid}.csv"
  bboxPath2="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/curriculumBO/start${curriStart}_decay${curriDecayRate}_${optimizer}_${metric}/bboxInfo${i}_${numValid}.csv"
