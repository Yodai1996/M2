...
do
  ...
  #training the model
  python ../codes/train_continual2.py ${trainPath} ${validPath} ${testPath} ${bboxPath} ${bboxPath2} ${testBbox} ${model} ${epoch} ${batch_size} ${numSamples} ${i} ${savePath} "adversarialBO" ${optimizer} >> ../train_log/adversarialBO/${optimizer}/model${i}_${trainPath}_${validPath}_${testPath}_${model}_epoch${epoch}_batchsize${batch_size}.txt
  echo $i'_finished'
