...
#PBS -o adversarialBO2_VSGD_Dice.txt
#PBS -j oe
#PBS -m abe
...
numIter=2 #30 #4 #30 #4 #iteration for BO
...
decayRate='0.9' #'0.9' #how much we decay the variability
...
modelPath="/lustre/gk36/k77012/M2/model/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/"
mkdir -p ${modelPath}
mkdir -p "/lustre/gk36/k77012/M2/train_log/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/"
...
do
  ...
  boDir="/lustre/gk36/k77012/M2/bo_io/in/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}"
  mkdir -p ${boDir}
  ...
  do
    ...
    #save information
    abnormalDir="/lustre/gk36/k77012/M2/data/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/ver${i}/iter${j}_${numInfer}/"
    segMaskDir="/lustre/gk36/k77012/M2/SegmentationMask/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/ver${i}/mask${j}_${numInfer}/" #まあ無くてもよさそう
    paraDir="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/ver${i}/"
    bboxDir="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/ver${i}/"
  ...
  abnormalDir="/lustre/gk36/k77012/M2/data/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/${trainPath}/"
  segMaskDir="/lustre/gk36/k77012/M2/SegmentationMask/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/ver${i}_${numTrain}/"
  paraPath="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/parameterInfo${i}_${numTrain}.csv"
  bboxPath="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/bboxInfo${i}_${numTrain}.csv"
  ...
  abnormalDir2="/lustre/gk36/k77012/M2/data/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/${validPath}/"
  segMaskDir2="/lustre/gk36/k77012/M2/SegmentationMask/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/ver${i}_${numValid}/"
  paraPath2="/lustre/gk36/k77012/M2/simDataInfo/paraInfo/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/parameterInfo${i}_${numValid}.csv"
  bboxPath2="/lustre/gk36/k77012/M2/simDataInfo/bboxInfo/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/bboxInfo${i}_${numValid}.csv"
  ...
  savePath="adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/${trainPath}/${validPath}_test${testPath}/${model}_batch${batch_size}_epoch${epoch}"
  ...
  #training the model
  python ../codes/train_continual.py ${abnormalDir} ${abnormalDir2} ${testPath} ${bboxPath} ${bboxPath2} ${testBbox} ${modelPath} ${model} ${epoch} ${batch_size} ${numSamples} ${i} ${savePath} ${optimizer} ${metric} {variability} ${decayRate} >> ../train_log/adversarialBO/${optimizer}_${metric}_variability${variability}_decay${decayRate}/model${i}_${trainPath}_${validPath}_${testPath}_${model}_epoch${epoch}_batchsize${batch_size}.txt
  echo $i'_finished'
