...
# Fully convolutional layers in feature extraction part compared to GrayVGG16_BN
...
class GrayVGG16_FC_BN(nn.Module):
    def __init__(self, in_dim = 1, num_classes = 1000):
        super(GrayVGG16_FC_BN, self).__init__()
        # feature extraction part
